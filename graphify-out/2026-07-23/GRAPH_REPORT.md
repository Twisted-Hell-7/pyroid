...
## Corpus Check
- 123 files · ~88,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2545 nodes · 4583 edges · 123 communities (103 shown, 20 thin omitted)
...
Cohesion: 0.06
Nodes (7): CodeEditorViewModel, AndroidViewModel, androidx, CursorPosition, Job, StateFlow, CursorInfo
...
Cohesion: 0.05
Nodes (37): CheckboxRow(), CodeContent(), CodeEditorScreen(), EditorContent(), EditorSettingsDialog(), GoToLineDialog(), androidx, com (+29 more)

### Community 5 - "Editor ViewModel"
Cohesion: 0.06
Nodes (20): EditorScreen(), EditorViewModel, StateFlow, ViewModel, EmptyState(), FileCard(), FileGrid(), formatDate() (+12 more)
...
Cohesion: 0.11
Nodes (5): IntelliSenseEngine, Job, StateFlow, IntelliSenseConfig, ParameterHints
...
Cohesion: 0.16
Nodes (6): ExecutionEngine, androidx, Job, SharedFlow, StateFlow, ExecutionResult

### Community 19 - "Completion Providers"
Cohesion: 0.35
Nodes (8): CompletionProvider, BuiltinInfo, BuiltinProvider, FunctionInfo, FunctionProvider, KeywordProvider, ModuleProvider, SnippetProvider

### Community 20 - "File Manager"
Cohesion: 0.10
Nodes (7): AppSettings, BackupSettings, ConsoleSettings, EditorSettingsState, PackageSettings, ThemeSettings, TimeoutSettings
...
Cohesion: 0.13
Nodes (6): ErrorItem(), REPLHistoryItem(), REPLScreen(), StateFlow, ViewModel, REPLViewModel
...
Cohesion: 0.27
Nodes (3): InterpreterManager, InterpreterSession, StateFlow
...
### Community 28 - "File Manager UI"
Cohesion: 0.13
Nodes (3): IntelliSenseViewModel, StateFlow, ViewModel
...
Cohesion: 0.27
Nodes (3): InterpreterConfig, PythonException, REPLHistoryEntry
...
Cohesion: 0.04
Nodes (3): Flow, T, SettingsDataStore
...
Cohesion: 0.47
Nodes (5): AnimatedFAB(), AnimatedSmallFAB(), Modifier, RotatingFAB(), Composable
...
### Community 90 - "SortBy"
Cohesion: 0.19
Nodes (14): AnimatedScrollToTopButton(), FastScrolling, Flinging, Idle, InfiniteScrollingList(), Job, LazyListState, Modifier (+6 more)
...
### Community 104 - "VirtualizedOutputList"
Cohesion: 0.57
Nodes (7): ChunkedOutputList(), FilteredVirtualizedList(), LazyListState, Modifier, OutputItem(), StreamingOutputList(), VirtualizedOutputList()
...
Cohesion: 0.21
Nodes (3): CompletionContext, CompletionItem, ParameterInfo
...
Cohesion: 0.29
Nodes (6): ExecutionRequest, Priority, HIGH, IMMEDIATE, LOW, NORMAL

### Community 113 - "RuntimeModule"
Cohesion: 0.16
Nodes (3): PythonNativeBridge, Context, RuntimeModule
...
- **Why does `CodeEditorViewModel` connect `Code Editor Core` to `Bracket Handler`, `Code Editor UI`, `Completion Providers`, `File Repository`, `File Manager ViewModel`, `ViewMode`?**
